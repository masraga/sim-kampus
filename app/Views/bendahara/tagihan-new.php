...
<body>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block"><?php echo session()->get("token") ?></div></a>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url() ?>/bendahara" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
              ...
              <li class="active"><a class="nav-link" href="/bendahara/tagihan/new"><i class="far fa-square"></i> <span>Tambah Tagihan</span></a></li>
            </ul>
  ...
  <script type="text/javascript" src="<?php echo base_url("url-helper.js") ?>"></script>
